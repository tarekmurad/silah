...
import 'package:silah_connect/l10n/locale_keys.g.dart';
                  ...
                  children: [
                    ...
                    BlocBuilder<ResetPasswordBloc, ResetPasswordState>(
                      ...
                      buildWhen: (previous, current) =>
                          previous.oldPassword != current.password,
                        ...
                        return Column(
                          ...
                          children: [
                            PasswordTextHintFieldWidget(
                              ...
                              hintText: LocaleKeys.lbl_old_password.tr(),
                              onChanged: (text) {
                                if (_oldPasswordTimeHandle?.isActive ?? false) {
                                  _oldPasswordTimeHandle!.cancel();
                                }
                                _oldPasswordTimeHandle = Timer(
                                    const Duration(milliseconds: 250), () {
                                  _bloc.add(
                                      OldPasswordChanged(oldPassword: text));
                                });
                              },
                            ),
                            SizedBox(
