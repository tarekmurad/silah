                ...
                children: [
                  ...
                  BlocBuilder<LibraryBloc, LibraryState>(
                    ...
                    buildWhen: (previous, current) {
                      if (current is GetFavoritesListLoadingState ||
                          current is GetFavoritesListSucceedState ||
                          current is GetFavoritesListFailedState) {
                        return true;
                      } else {
                        return false;
                      }
                    ...
                    builder: (context, state) {
                      ...
                      } else if (state is GetFavoritesListSucceedState) {
                        if (state.folders.isEmpty) {
                          return Expanded(
                            child: Center(
                              child: Text(
                                'There is no favorites items!',
